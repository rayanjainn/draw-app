        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              A powerful collaborative drawing platform that brings your team's
              ideas to life. Sketch, design, and brainstorm in real-time with
              anyone, anywhere.
            </p>
            <div className="flex justify-center space-x-4">
              <button className="bg-violet-600 text-white px-8 py-3 rounded-lg hover:bg-violet-700 transition-colors flex items-center">
                Get Started <ChevronRight className="ml-2 w-4 h-4" />
              </button>
              <button className="border border-gray-700 text-gray-300 px-8 py-3 rounded-lg hover:bg-gray-800 transition-colors flex items-center">
      ...
      <section className="py-20 bg-violet-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-violet-200 mb-8 max-w-2xl mx-auto">
            Join thousands of teams who are already using DrawFlow to
